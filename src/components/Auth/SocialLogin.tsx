...
export const processLoginResponse = (response: any, navigation:any) => {
...
export const kakao_login = (navigation:any) => {
...
export const naver_login = async (navigation:any) => {
  NaverLogin.login({
    appName: 'SASM',
...
export const google_login = (navigation:any) => {
...
export default function SocialLogin({ type }: { type: string }) {
  ...
  return (
    <View>
      <Button style={{borderColor:'#000000', borderWidth: 1}} onPress={()=>google_login(navigation)}>
      ...
      <Button style={{backgroundColor:'#03C75A'}} onPress={()=>naver_login(navigation)}>
      ...
      <Button style={{backgroundColor:'#FEE500'}} onPress={()=>kakao_login(navigation)}>

...
const PostUploadScreen = ({
  navigation,
  route,
}: NativeStackScreenProps<CommunityStackParams, "PostUpload">) => {
  ...
  const uploadPost = async () => {
    if (board_id == undefined || boardFormat == undefined) return;
    ...
    if (post_id) {
      ...
      const response = await request.put(
        `/community/posts/${post_id}/update/`,
        formData,
